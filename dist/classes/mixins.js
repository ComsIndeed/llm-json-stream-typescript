 ...
 */
export function createDelegate(character, propertyPath, jsonStreamParserController, onComplete) {
    switch (character) {
        case " ":
        case "\n":
        case "\r":
        ...
        case "8":
        case "9":
            return new NumberPropertyDelegate(propertyPath, jsonStreamParserController, onComplete);
        case "t":
        case "f":
            return new BooleanPropertyDelegate(propertyPath, jsonStreamParserController, onComplete);
        case "n":
            return new NullPropertyDelegate(propertyPath, jsonStreamParserController, onComplete);
        default:
            throw new Error(`No delegate available for character: |${character}|`);
    }
}
