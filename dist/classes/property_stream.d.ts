 ...
 */
export declare class ObjectPropertyStream extends PropertyStream<Record<string, any>> {
 ...
 */
export declare class ArrayPropertyStream<T = any> extends PropertyStream<T[]> {
    private propertyPath;
